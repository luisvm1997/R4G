...
namespace R4G.App.Data.Static
{
    public static class ProximasCarrerasData
    {
        ...
        public static List<ProximaCarrera> CarrerasAragon = new()
        {
            new ProximaCarrera
            {
        ...
        public static List<ProximaCarrera> CarrerasEspaña = new()
{
    new ProximaCarrera
    {
    ...
    new ProximaCarrera
    {
        ...
        Hora = "17:30",
        Enlace = "https://cursanassos.barcelona",
    ...
    new ProximaCarrera
    {
        ...
        Hora = "9:00",
        Enlace = "https://www.edpmediomaratondesevilla.es",
    ...
    new ProximaCarrera
    {
        ...
        Hora = "9:00",
        Enlace = "https://www.mediamaratonmadrid.es",
    ...
    new ProximaCarrera
    {
        ...
        Hora = "9:00",
        Enlace = "https://www.runrocknroll.com/madrid",
